        ...
        <div className="flex flex-col w-full md:w-[80%] bg-gray-50 rounded-lg">
            <div className="p-4 sm:py-6 bg-blue-600 text-white text-lg sm:text-2xl font-bold sticky top-0 z-10">
                <div className="h-full w-full flex justify-between">
                    <span className="h-full flex justify-center items-center">Find Fams</span>
                    <span className="h-full flex justify-center items-center">
                        <button onClick={() => setShowCreate(true)} className="p-2 hover:bg-blue-500 hover:text-blue-100 rounded">
                            + Create New
                        </button>
                    </span>
                </div>
